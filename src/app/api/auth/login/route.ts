...
const DEMO_USERS: Record<string, { id: string; role: string; name: string; password: string }> = {
  ...
  "housekeeping1@iimdemo.com": { id: "00000000-0000-0000-0000-000000000016", role: "housekeeping", name: "Housekeeping Staff 1", password: "password123" },
  "housekeeping2@iimdemo.com": { id: "00000000-0000-0000-0000-000000000017", role: "housekeeping", name: "Housekeeping Staff 2", password: "password123" },
  "maintenance1@iimdemo.com": { id: "00000000-0000-0000-0000-000000000018", role: "maintenance_staff", name: "Maintenance Staff 1", password: "password123" },
